        ...
        <form action="{{ route("admin.products.store") }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
             ...
             <div class="form-group {{ $errors->has('cod_product') ? 'has-error' : '' }}">
                <label for="cod_product">{{ trans('global.product.fields.cod_product') }}*</label>
                <input type="text" id="cod_product" name="cod_product" class="form-control" value="{{ old('cod_product', isset($product) ? $product->cod_product : '') }}">
                @if($errors->has('cod_product'))
                    <p class="help-block">
                        {{ $errors->first('cod_product') }}
                    </p>
                @endif
                <p class="helper-block">
                    {{ trans('global.product.fields.cod_product_helper') }}
                </p>
            </div>
